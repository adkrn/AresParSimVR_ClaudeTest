...
namespace Oculus.Movement.Locomotion
{
    ...
    public class MovementSDKLocomotion : MonoBehaviour
    {
        ...
        private Vector2 ScaledByVelocity(Vector3 directionInput)
        {
            ...
            float actualSpeed = Vector3.Dot(realDirection, _rigidbody.linearVelocity);
        ...
        private void UpdateMovement()
        {
            ...
            else
            {
                ...
                _rigidbody.linearVelocity = locomotionVelocity + CurrentFallVelocity();
            }
        }

        private Vector3 CurrentFallVelocity()
        {
            float currentFallSpeed = Vector3.Dot(_rigidbody.linearVelocity, Vector3.down);
